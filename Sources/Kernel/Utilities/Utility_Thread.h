...
#ifndef KERNEL_UTILITIES_UTILITY_THREAD_H_
#define KERNEL_UTILITIES_UTILITY_THREAD_H_
...
class CPARAM_THREADPROC {
 public:
  ...
  BOOL bStartThreadEx(LPTHREAD_START_ROUTINE NewThreadProc, HANDLE hActionEvent,
                      LPVOID pvBuffer);
...
#endif  // KERNEL_UTILITIES_UTILITY_THREAD_H_