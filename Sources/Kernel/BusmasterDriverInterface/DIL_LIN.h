...
public:
     ...
     */
    HRESULT DILL_GetTimeModeMapping(SYSTEMTIME& CurrSysTime, UINT64& TimeStamp, LARGE_INTEGER& QueryTickCount);
...
private:
    ...
    HRESULT( *m_pfDisplayConfigDlg )( SCONTROLLER_DETAILS_LIN* InitData, int& Length );
