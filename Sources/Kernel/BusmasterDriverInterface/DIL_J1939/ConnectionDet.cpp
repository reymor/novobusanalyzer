...
CConnectionDet::CConnectionDet(BYTE bySrcAddress, BYTE byDestAddress) {
...
BOOL CConnectionDet::bIsMsgRxForThisConnection(UINT32 unExtId) {
  ...
  return (((byDestAdres == m_bySrcAddress) || (byDestAdres == ADDRESS_ALL) ||
           (byPF > 239)) &&
...
eCON_STATUS CConnectionDet::eGetConStatus(void) { return m_eConStatus; }