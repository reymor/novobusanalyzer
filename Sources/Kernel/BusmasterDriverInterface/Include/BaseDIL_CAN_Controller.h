...
#ifndef KERNEL_BUSMASTERDRIVERINTERFACE_BASEDIL_CAN_CONTROLLER_H_
#define KERNEL_BUSMASTERDRIVERINTERFACE_BASEDIL_CAN_CONTROLLER_H_
...
class CBaseDIL_CAN_Controller {
 public:
   ...
   * @return S_OK for success, S_FALSE for failure
   */
  virtual HRESULT CAN_SelectHwInterface(
   ...
   */
  virtual HRESULT CAN_SetControllerParams(int nValue,
                                          ECONTR_PARAM eContrparam) = 0;
  ...
  virtual HRESULT CAN_SetHardwareChannel(PSCONTROLLER_DETAILS, DWORD dwDriverId,
                                         bool bIsHardwareListed,
                                         unsigned int unChannelCnt) = 0;

  virtual ~CBaseDIL_CAN_Controller() {}
};

#endif  // KERNEL_BUSMASTERDRIVERINTERFACE_BASEDIL_CAN_CONTROLLER_H_