#ifndef KERNEL_BUSMASTERDRIVERINTERFACE_CANDRIVERDEFINES_H_
#define KERNEL_BUSMASTERDRIVERINTERFACE_CANDRIVERDEFINES_H_
...
class SCONTROLLER_DETAILS {
 public:
  ...
  // acceptance code byte1 information
  std::string m_omStrAccCodeByte1[defCAN_MSG_IDS];
  // acceptance code byte2 information
  std::string m_omStrAccCodeByte2[defCAN_MSG_IDS];
  // acceptance code byte3 information
  std::string m_omStrAccCodeByte3[defCAN_MSG_IDS];
  // acceptance code byte4 information
  std::string m_omStrAccCodeByte4[defCAN_MSG_IDS];
  // acceptance mask byte1 information
  std::string m_omStrAccMaskByte1[defCAN_MSG_IDS];
  // acceptance mask byte2 information
  std::string m_omStrAccMaskByte2[defCAN_MSG_IDS];
  // acceptance mask byte3 information
  std::string m_omStrAccMaskByte3[defCAN_MSG_IDS];
  // acceptance mask byte4 information
  std::string m_omStrAccMaskByte4[defCAN_MSG_IDS];
  // Hw description which user can
...
class SERROR_INFO {
 public:
  /**
   * Error Type.
   * Can be ERROR_BUS, ERROR_DEVICE_BUFF_OVERFLOW, ERROR_DRIVER_BUFF_OVERFLOW,
   * ERROR_UNKNOWN
   */
...
#endif  // KERNEL_BUSMASTERDRIVERINTERFACE_CANDRIVERDEFINES_H_