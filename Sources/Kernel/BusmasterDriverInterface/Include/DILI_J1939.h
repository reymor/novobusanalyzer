...
#ifndef KERNEL_BUSMASTERDRIVERINTERFACE_DILI_J1939_H_
#define KERNEL_BUSMASTERDRIVERINTERFACE_DILI_J1939_H_
...
class CDILI_J1939 : public CBaseDILI_J1939 {
  ...
  */
  HRESULT DILIJ_Initialise(CBaseDIL_CAN* pouIDIL_CAN);
  ...
  */
  ...
  2.S_FALSE for failure.
  */
  HRESULT DILIJ_SendAckMsg(DWORD dwClient, UINT unChannel, ETYPE_ACK eAckType,
                           UINT32 unPGN, BYTE bySrc, BYTE byAddresAck);
  ...
  2.S_FALSE for failure.
  */
  HRESULT DILIJ_RequestPGN(DWORD dwClient, UINT unChannel, UINT32 unPGN,
                           BYTE byPriority = DEFAULT_PRIORITY,
                           BYTE bySrc = ADDRESS_NULL,
  ...
  */
  ...
  2.S_FALSE for failure.
  */
  HRESULT DILIJ_NM_ClaimAddress(DWORD dwClientId, UINT unChannel,
                                BYTE byAddress,
                                BYTE byPriority = DEFAULT_PRIORITY);
  ...
  */
  ...
  2.S_FALSE for failure.
  */
  HRESULT DILIJ_ConfigureTimeOut(ETYPE_TIMEOUT eTimeOutType,
                                 UINT unMiliSeconds);
...
#endif  // KERNEL_BUSMASTERDRIVERINTERFACE_DILI_J1939_H_