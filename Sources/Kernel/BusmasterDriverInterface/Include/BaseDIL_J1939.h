...
#ifndef KERNEL_BUSMASTERDRIVERINTERFACE_BASEDIL_J1939_H_
#define KERNEL_BUSMASTERDRIVERINTERFACE_BASEDIL_J1939_H_
#include <Windows.h>
...
class CBaseDILI_J1939 : public IBusService {
 public:
  /*Initializes J1939 network
  Parameters:
  1.pouSAE_J1939 Pointer to the object which contains list of all SAE defined
  PGNS and SPNs. 2.pILog pointer to wrapper_error object. Return value: 1.S_OK
  for success or 2.S_FALSE for failure.
  */
  virtual HRESULT DILIJ_Initialise(CBaseDIL_CAN* pIDIL_CAN) = 0;
  ...
  */
  ...
  2.S_FALSE for failure.
  */
  virtual HRESULT DILIJ_RequestPGN(DWORD dwClient, UINT unChannel, UINT32 unPGN,
                                   BYTE byPriority = DEFAULT_PRIORITY,
                                   BYTE bySrc = ADDRESS_NULL,
                                   BYTE byDestAddress = ADDRESS_ALL) = 0;

  /* Starts J1939 network. All nodes start sending according to the
  configuration. Return value: 1.S_OK for success or 2.S_FALSE for failure.
  */
  ...
  */
  ...
  2.S_FALSE for failure.
  */
  virtual HRESULT DILIJ_GetTimeOut(ETYPE_TIMEOUT eTimeOutType,
                                   UINT& unMiliSeconds) = 0;
  ...
  2.S_FALSE for failure.
  */
  virtual HRESULT DILIJ_ConfigureTimeOut(ETYPE_TIMEOUT eTimeOutType,
                                         UINT unMiliSeconds) = 0;

  /* Get the time mode mapping */
  virtual HRESULT DILIJ_GetTimeModeMapping(SYSTEMTIME& CurrSysTime,
                                           UINT64& unAbsTime) = 0;
  ...
  */
  ...
  2.S_FALSE for failure.
  */
  virtual HRESULT DILIJ_SetCallBckFuncPtr(DWORD dwClientId,
...
#endif  // KERNEL_BUSMASTERDRIVERINTERFACE_BASEDIL_J1939_H_