...
*/
// clang-format on
#ifndef KERNEL_BUSMASTERDRIVERINTERFACE_FLEXRAYDRIVERDEFINES_H_
#define KERNEL_BUSMASTERDRIVERINTERFACE_FLEXRAYDRIVERDEFINES_H_
...
#endif  // KERNEL_BUSMASTERDRIVERINTERFACE_FLEXRAYDRIVERDEFINES_H_