#ifndef KERNEL_BUSMASTERDRIVERINTERFACE_DEVICELISTINFO_H_
#define KERNEL_BUSMASTERDRIVERINTERFACE_DEVICELISTINFO_H_
...
const TYPE_CHANNEL CHANNEL_FLEXRAY_MIN =
    1;  // Minimum value of a FlexRay channel
const TYPE_CHANNEL CHANNEL_FLEXRAY_MAX =
    32;  // Maximum value of a FlexRay channel
...
class STATUSMSG {
 public:
  ...
  unsigned short wControllerStatus;
  // Flagfield of status information (UCI_FLXSTSINFO_???)
  unsigned long dwStatusInfoFlags;
};
...
/*Todo*/
enum eDirection { DIR_RX = 'R', DIR_TX = 'T', DIR_ALL };
...
#endif  // KERNEL_BUSMASTERDRIVERINTERFACE_DEVICELISTINFO_H_