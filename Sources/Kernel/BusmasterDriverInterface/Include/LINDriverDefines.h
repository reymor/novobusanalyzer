#ifndef KERNEL_BUSMASTERDRIVERINTERFACE_LINDRIVERDEFINES_H_
#define KERNEL_BUSMASTERDRIVERINTERFACE_LINDRIVERDEFINES_H_
...
enum eLinMsgType { LIN_MSG, LIN_EVENT };
...
enum eCheckSumType { CHECKSUM_CLASSIC, CHECKSU_ENHANCED };
...
#endif  // KERNEL_BUSMASTERDRIVERINTERFACE_LINDRIVERDEFINES_H_