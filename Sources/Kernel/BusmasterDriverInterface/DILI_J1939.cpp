 ...
 * InitInstance
 */
BOOL CDILI_J1939::InitInstance(void) { return TRUE; }

/**
 * ExitInstance
 */
int CDILI_J1939::ExitInstance(void) { return 0; }
 ...
 * Initialise
 */
HRESULT CDILI_J1939::DILIJ_Initialise(CBaseDIL_CAN* pIDIL_CAN) {
  if (pIDIL_CAN != nullptr) {
    return DILJ_Initialise(pIDIL_CAN);
  } else {
    return S_FALSE;
  }
}
 ...
 */
HRESULT CDILI_J1939::DILIJ_Uninitialise(void) { return DILJ_Uninitialise(); }
...
HRESULT CDILI_J1939::DILIJ_RegisterClient(BOOL bRegister, char* pacNodeName,
                                          ...
                                          DWORD& dwClientId) {
  return DILJ_RegisterClient(bRegister, pacNodeName, un64ECUName, byPrefAdres,
                             dwClientId);
}
 ...
 */
HRESULT CDILI_J1939::DILIJ_SendJ1939Msg(DWORD dwClientId, UINT unChannel,
 ...
 */
HRESULT CDILI_J1939::DILIJ_NM_RequestAddress(DWORD dwClient, UINT unChannel,
                                             BYTE byPriority, BYTE bySrc,
                                             BYTE byDestAddress) {
  return DILJ_NM_RequestAddress(dwClient, unChannel, byPriority, bySrc,
                                byDestAddress);
}
 ...
 */
HRESULT CDILI_J1939::DILIJ_NM_ClaimAddress(DWORD dwClientId, UINT unChannel,
 ...
 */
HRESULT CDILI_J1939::DILIJ_NM_CommandAddress(DWORD dwClient, UINT unChannel,
                                             UINT64 unECU_NAME,
                                             BYTE byNewAddress, BYTE byPriority,
 ...
 */
HRESULT CDILI_J1939::DILIJ_RequestPGN(DWORD dwClient, UINT unChannel,
                                      UINT32 unPGN, BYTE byPriority, BYTE bySrc,
                                      BYTE byDestAddress) {
  return DILJ_RequestPGN(dwClient, unChannel, unPGN, byPriority, bySrc,
                         byDestAddress);
}
 ...
 */
HRESULT CDILI_J1939::DILIJ_SendAckMsg(DWORD dwClient, UINT unChannel,
                                      ETYPE_ACK eAckType, UINT32 unPGN,
                                      BYTE bySrc, BYTE byAddresAck) {
  return DILJ_SendAckMsg(dwClient, unChannel, eAckType, unPGN, bySrc,
                         byAddresAck);
}
 ...
 */
HRESULT CDILI_J1939::DILIJ_GoOnline() { return DILJ_GoOnline(); }

HRESULT CDILI_J1939::DILIJ_ClaimAdress() { return DILJ_ClaimAdress(); }

/**
 * Stops J1939 network. All nodes stop sending msgs.
 */
HRESULT CDILI_J1939::DILIJ_GoOffline() { return DILJ_GoOffline(); }

/**
 * Get J1939 timeouts.
 */
HRESULT CDILI_J1939::DILIJ_GetTimeOut(ETYPE_TIMEOUT eTimeOutType,
                                      UINT& unMiliSeconds) {
 ...
 */
HRESULT CDILI_J1939::DILIJ_ConfigureTimeOut(ETYPE_TIMEOUT eTimeOutType,
                                            UINT unMiliSeconds) {
 ...
 */
BOOL CDILI_J1939::DILIJ_bIsOnline(void) { return DILJ_bIsOnline(); }

/**
 * Set call back function pointer.
 */
HRESULT CDILI_J1939::DILIJ_SetCallBckFuncPtr(DWORD dwClientId,
