...
class FlexRayCompuMethods : public CompuMethodProps {
 public:
  FlexRayCompuMethods() { this->m_eType = eProtocolType::eFlexRayProtocol; }
...
class FlexRayEcuProperties : public EcuProperties {
 public:
  ...
  int m_nKeySlotId;  // ID of the slot used to transmit the startup frame, sync
                     // frame, or designated single slot frame.

  int m_nWakeUpChannel;  // Channel used by the node to send a wakeup pattern (A
                         // or B).
...
class FlexRaySignalProps : public SignalProps {
 public:
  FlexRaySignalProps() { eType = eProtocolType::eFlexRayProtocol; }
};

class FlexRayPduProps : public PduProps {
 public:
  eFlexRayChannel m_oueChannel;
  FlexRayPduProps() { eType = eProtocolType::eFlexRayProtocol; }
};
