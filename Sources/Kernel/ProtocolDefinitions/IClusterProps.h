...
enum eErrorSeverity { eError, eWarning };
...
enum eDIR { eTx = DIRECTION_TX, eRx = DIRECTION_RX, eAllDir = DIRECTION_ALL };
...
class EcuProperties {
 public:
  ...
  EcuProperties() { m_eProtocol = eProtocolType::eInvalidProtocol; }
};

class FrameProps {
 public:
  FrameProps() { m_eProtocol = eProtocolType::eInvalidProtocol; }
  eProtocolType m_eProtocol;
...
class SignalGroupProps {
 public:
  SignalGroupProps() { eType = eProtocolType::eInvalidProtocol; }
  eProtocolType eType;
};

class SignalProps {
 public:
  SignalProps() { eType = eProtocolType::eInvalidProtocol; }
  eProtocolType eType;
  ...
  eMultiplexSignalIndicator
      m_eMultiplex;  // M = Switch , m = mulplexed signal, mIntM = Multipled
                     // signal and switch both
...
class PduProps {
 public:
  PduProps() { eType = eProtocolType::eInvalidProtocol; }
  eProtocolType eType;
...
class CompuMethodProps {
 public:
  CompuMethodProps() { m_eType = eProtocolType::eInvalidProtocol; }
