...
enum eLinSignalValueType { eScalar, eByteArray };
...
class ConfigFrameDetails {
 public:
  ...
  unsigned int
      m_unConfigMsgId;  // [0-0xFFFE] valid only for slave protocol version 2.0
...
enum eLinEcuType { eEcuNone, eMaster, eSlave };

class LinEcuProps : public EcuProperties {
 public:
  LinEcuProps() { m_eProtocol = eProtocolType::eLINProtocol; }
...
class LinFrameProps : public FrameProps {
 public:
  LinFrameProps() { m_eProtocol = eProtocolType::eLINProtocol; }
...
class LINSignalProps : public SignalProps {
 public:
  LINSignalProps() { eType = eProtocolType::eLINProtocol; }
  eLinSignalValueType m_ouValueType;
};

class LinSignalGroupProps : public SignalGroupProps {
 public:
  LinSignalGroupProps() { eType = eProtocolType::eLINProtocol; }
...
class LINCompuMethods : public CompuMethodProps {
 public:
  LINCompuMethods() { m_eType = eProtocolType::eLINProtocol; }
