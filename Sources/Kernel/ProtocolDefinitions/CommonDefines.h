...
const std::string m_omDialType[eLIN_SID_ALL] = {
    "UnConditional",        "Master Request",  "Slave Response",
    "AssignFrameId",        "UnassignFrameId", "AssignNAD",
    "ConditionalChangeNAD", "DataDump",        "SaveConfiguration",
    "AssignFrameIdRange",   "FreeFormat",      "ReadyByIdentifier"};

enum eSignalType { eSignalNormal, eSignalDiag };

enum eSignalDataType { Invalid, eSigned, eUnsigned, Float, Double, ByteArray };
...
enum eFormat { HEXADECIMAL = 0, DEC };
