...
enum eCANMsgType { eCan_Standard, eCan_Extended };

class CANFrameProps : public FrameProps {
 public:
  CANFrameProps() { m_eProtocol = eProtocolType::eCANProtocol; }
  eCANMsgType m_canMsgType;
};

class CANCompuMethods : public CompuMethodProps {
 public:
  CANCompuMethods() { this->m_eType = eCANProtocol; }
  CCompuMethod m_CompuMethod;
};

class CANSignalProps : public SignalProps {
 public:
  CANSignalProps() { this->eType = eCANProtocol; }
};
...
class CANEcuProperties : public EcuProperties {
 public:
  ...
  CANEcuProperties() { m_eProtocol = eProtocolType::eCANProtocol; }
};
