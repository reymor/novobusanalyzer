...
public:
     ...
     */
    void vCalculateAndFormatTM(BYTE bExprnFlag, UINT64 TimeStamp, char acTime[], int bufferSize);

    void vCalAndFormatTM_Offline(BYTE bExprnFlag, UINT64 TimeStamp, char acTime[], int bufferSize);
