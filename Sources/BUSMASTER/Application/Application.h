...
CMsgBufFSE<STCANDATA> g_ouCanBufForCOM;
...
public:
    ...
    ******************************************************************************/
    HRESULT GetLoggingBlockCount(USHORT* BlockCount)
    {
        ...
        if (NULL != pCANLogger)
        {
            *BlockCount = pCANLogger->GetLoggingBlockCount();
            hResult = S_OK;
        }
    ...
    ******************************************************************************/
    HRESULT RemoveLoggingBlock(USHORT BlockIndex)
    {
        ...
        if (NULL != pCANLogger)
        {
            hResult = pCANLogger->RemoveLoggingBlock(BlockIndex);
        }
    ...
    ******************************************************************************/
    HRESULT ClearLoggingBlockList(void)
    {
        ...
        if (NULL != pCANLogger)
        {
            hResult = pCANLogger->ClearLoggingBlockList();
        }
    ...
    ******************************************************************************/
    HRESULT AddLoggingBlock(SLOGGINGBLOCK_USR* psLoggingBlock)
    {
        ...
        if (NULL != pCANLogger)
        {
            hResult = pCANLogger->StartEditingSession();
            if (S_OK == hResult)
            {
                hResult = pCANLogger->AddLoggingBlock(logInfo);
            }
            pCANLogger->StopEditingSession(true);
        }
    ...
    ******************************************************************************/
    HRESULT StartLogging()
    {
        ...
        if (NULL != pCANLogger)
        {
            hResult = pCANLogger->EnableLogging(TRUE);
        }
    ...
    ******************************************************************************/
    HRESULT StopLogging()
    {
        ...
        if (NULL != pCANLogger)
        {
            hResult = pCANLogger->EnableLogging(FALSE);
        }
    ...
    ******************************************************************************/
    HRESULT WriteToLogFile(USHORT /*BlockIndex*/, BSTR bstrStr)
    {
        ...
        if (NULL != pCANLogger)
        {
            ...
            CString omStr(acStr);
            hResult = pCANLogger->LogString(omStr);
        }
