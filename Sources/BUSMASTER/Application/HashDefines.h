...
#define MSG_INVALID_SG_NAME     "Invalid Signal name specified.\n\nSignal name must begin with [A-Z],[a-z] or a '_' and \nmay only contain alpanumeric and '_' characters."
#define MSG_INVALID_MSG_NAME    "Invalid Message name specified.\n\nMessage name must begin with [A-Z],[a-z] or a '_' and \nmay only contain alpanumeric and '_' characters."
...
#define WM_IMPORTLOG_PAGENO_CHANGE  WM_USER + 111  //Import Log Change in Page No.
#define WM_IMPORTLOG_OVERWRITE_SCROLL  WM_USER + 112  //Import Log Overwrite Scroll.
...
#define defDISSOCIATE_WARNING   "Are you sure you want to dissociate the file(s)?"
...
#define defFILTER_IMAGE_INDEX_ECU               4
...
#define defSTR_ERR_IMPORTLOG_FILE_SIZE_EXCEEDED     "Unable to load file size is beyond %d Gb"
#define defSTR_ERR_IMPORTLOG_INVALID_FILE     "The file provided is Invalid."
