...
/**
 * \file      NumEdit.cpp
 * \brief     Implementation file for CKeyNumEdit
 * \author    Arunkumar K
 * \copyright Copyright (c) 2011, Robert Bosch Engineering and Business Solutions. All rights reserved.
 *
 * Implementation file for CKeyNumEdit
 */
...
// For CKeyNumEdit Class definition
#include "KeyNumEdit.h"

/////////////////////////////////////////////////////////////////////////////
// CEditItem
#define IDC_NUM_CONTROL         0x12345
/******************************************************************************
 Function Name  :   CKeyNumEdit

 Description    :   Constructor
 Member of      :   CKeyNumEdit
 ...
 Modifications  :
******************************************************************************/
CKeyNumEdit::CKeyNumEdit( int nItem,
                          int nSubItem,
                          CString& sContent,
...
void CKeyNumEdit::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
    ...
    switch(nChar) {
        ...
        case VK_RIGHT:
        {
            GetParent()->SendMessage (WM_KEYDOWN, nChar, 0L);
            break;
        }
        case VK_F2 :
        {
            GetParent()->SendMessage (WM_KEYDOWN, VK_F2, 0L);
            break;
        }
        default :
        {
...
*******************************************************************************/
int CKeyNumEdit::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
    int nRetVal = 0;
...
void CKeyNumEdit::OnKillFocus(CWnd* pNewWnd)
{
    ...
    if (pNewWnd != nullptr && pNewWnd != m_pMainWnd ) {
        ...
        lvDisplayInfo.item.state = m_sInfo.m_byBase;
