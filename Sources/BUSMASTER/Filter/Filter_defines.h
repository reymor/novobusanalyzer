...
#define defSTR_FILTER_DETAILS_MSG_CHANNEL_MASK  "Mask"
...
#define defFILTER_TYPE_ALL_FRAMES               6
...
public:
    ...
    std::string  m_omStrMsgChannelMask;
    int     m_nImageIndex;
};
