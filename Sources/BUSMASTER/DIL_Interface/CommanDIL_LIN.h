...
public:
    ...
    virtual HRESULT LIN_SetConfigData(IBMNetWorkGetService* ouConfig);
    ...
    virtual HRESULT LIN_GetConfiguration(SCONTROLLER_DETAILS_LIN[], INT& nSize) = 0;
    ...
    virtual HRESULT SetConfigData(IBMNetWorkGetService* ouConfig) = 0;
