#ifndef BUSMASTER_LDFEDITOR_EVENTFRAMEEDITDLG_H_
#define BUSMASTER_LDFEDITOR_EVENTFRAMEEDITDLG_H_
...
class EventFrameEditDlg : public QDialog {
  Q_OBJECT
 public:
  EventFrameEditDlg(ICluster* pCluster, IFrame** pouFrame, bool bNew,
                    QWidget* parent = 0);
...
#endif  // BUSMASTER_LDFEDITOR_EVENTFRAMEEDITDLG_H_