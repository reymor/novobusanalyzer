...
LDFNetworkView::LDFNetworkView(QWidget* parent) : QTreeWidget(parent) {
  ...
  m_ouIcons[defSIGNAL_RX_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/16x16/Signals.png", QSize(16, 16));
  m_ouIcons[defSIGNAL_RX_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/22x22/Signals.png", QSize(22, 22));
  m_ouIcons[defSIGNAL_RX_ICON_INDEX].addFile(
  ...
  m_ouIcons[defSIGNAL_TX_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/16x16/Signals.png", QSize(16, 16));
  m_ouIcons[defSIGNAL_TX_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/22x22/Signals.png", QSize(22, 22));
  m_ouIcons[defSIGNAL_TX_ICON_INDEX].addFile(
  ...
  m_ouIcons[defFRAME_RX_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/16x16/Frame.png", QSize(16, 16));
  m_ouIcons[defFRAME_RX_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/22x22/Frame.png", QSize(22, 22));
  m_ouIcons[defFRAME_RX_ICON_INDEX].addFile(
  ...
  m_ouIcons[defFRAME_TX_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/16x16/Frame.png", QSize(16, 16));
  m_ouIcons[defFRAME_TX_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/22x22/Frame.png", QSize(22, 22));
  m_ouIcons[defFRAME_TX_ICON_INDEX].addFile(
...
void LDFNetworkView::OnElementDeleted(UID_ELEMENT uid) {
  IElement* pElement;
  m_pouLdfCluster->GetElement(m_pouLdfCluster->GetElementType(uid), uid,
                              &pElement);
...
void LDFNetworkView::OnElementCreated(UID_ELEMENT uid) {
  ...
  switch (pElement->GetElementType()) {
    case eEcuElement: {
      ...
      ouEcuTreeWidgets.m_pTreeWidgets[def_EcuTreeWidget_Index]->setText(
          0, QString::fromStdString(strItemTitle));
      ouEcuTreeWidgets.m_pTreeWidgets[def_EcuTreeWidget_Index]->setIcon(
          0, m_ouIcons[defECU_ICON_INDEX]);

      ouTreeItemId.m_uidElement = pEcu->GetUniqueId();
      ouVariant.setValue(ouTreeItemId);
      ouEcuTreeWidgets.m_pTreeWidgets[def_EcuTreeWidget_Index]->setData(
          0, Qt::UserRole, ouVariant);
      m_UidTreeWidgetListMap[ouTreeItemId.m_uidElement].push_back(
          ouEcuTreeWidgets.m_pTreeWidgets[def_EcuTreeWidget_Index]);
...
void LDFNetworkView::vAddSignals(EcuTreeWidgets& ouEcuTreeWidgets, IEcu* pEcu) {
  ...
  QTreeWidgetItem* pouTxTableItem =
      ouEcuTreeWidgets.m_pTreeWidgets[def_TxSignalTreeWidget_Index];
  ...
  ouEcuTreeWidgets.m_pTreeWidgets[def_EcuTreeWidget_Index]->addChild(
      pouTxTableItem);
  ...
  QTreeWidgetItem* pouRxTableItem =
      ouEcuTreeWidgets.m_pTreeWidgets[def_RxSignalTreeWidget_Index];
...
void LDFNetworkView::vAddFrames(EcuTreeWidgets& ouEcuTreeWidgets, IEcu* pEcu) {
  ...
  QTreeWidgetItem* pouTxTableItem =
      ouEcuTreeWidgets.m_pTreeWidgets[def_TxFrameTreeWidget_Index];
  ...
  QTreeWidgetItem* pouRxTableItem =
      ouEcuTreeWidgets.m_pTreeWidgets[def_RxFrameTreeWidget_Index];
...
ERRORCODE LDFNetworkView::OnClusterChange(eAction eActionType, UID_ELEMENT nId,
...
void LDFNetworkView::vHandleElementChange(eAction eActionType, UID_ELEMENT nId,
                                          void* pAcionData) {
...
void LDFNetworkView::vHandleEcuElementChange(eAction eActionType,
                                             UID_ELEMENT nId,
                                             void* pAcionData) {
  if (eDeleted == eActionType) {
    OnElementDeleted(nId);
