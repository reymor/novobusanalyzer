#ifndef BUSMASTER_LDFEDITOR_MAPSIGNALSDLG_H_
#define BUSMASTER_LDFEDITOR_MAPSIGNALSDLG_H_
...
class MapSignalsDlg : public QDialog {
  Q_OBJECT
 public:
  MapSignalsDlg(UID_ELEMENT uidECU, int nFrameLen,
 ...
 private:
  ...
  ERRORCODE vValidateSignalStartBit(UID_ELEMENT uidSignal, int, QString strSB,
...
#endif  // BUSMASTER_LDFEDITOR_MAPSIGNALSDLG_H_