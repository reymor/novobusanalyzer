...
LDFElementView::LDFElementView(QWidget* parent) : QTreeWidget(parent) {
  m_ouIcons[defFRAME_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/16x16/Frame.png", QSize(16, 16));
  m_ouIcons[defFRAME_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/22x22/Frame.png", QSize(22, 22));
  m_ouIcons[defFRAME_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/32x32/Frame.png", QSize(32, 32));

  m_ouIcons[defECU_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/16x16/Ecu.png", QSize(16, 16));
  m_ouIcons[defECU_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/22x22/Ecu.png", QSize(22, 22));
  m_ouIcons[defECU_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/32x32/Ecu.png", QSize(32, 32));

  m_ouIcons[defSIGNAL_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/16x16/Signals.png", QSize(16, 16));
  m_ouIcons[defSIGNAL_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/22x22/Signals.png", QSize(22, 22));
  m_ouIcons[defSIGNAL_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/32x32/Signals.png", QSize(32, 32));

  m_ouIcons[defCODING_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/16x16/Coding.png", QSize(16, 16));
  m_ouIcons[defCODING_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/22x22/Coding.png", QSize(22, 22));
  m_ouIcons[defCODING_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/32x32/Coding.png", QSize(32, 32));

  m_ouIcons[defSCHEDULETABLE_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/16x16/ScheduleTable.png",
      QSize(16, 16));
  m_ouIcons[defSCHEDULETABLE_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/22x22/ScheduleTable.png",
      QSize(22, 22));
  m_ouIcons[defSCHEDULETABLE_ICON_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/32x32/ScheduleTable.png",
      QSize(32, 32));

  // we can use directly ecu icon.But fin feature if it reqired to chaange
  // icon...
  m_ouIcons[defNODE_COMPOSITION_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/16x16/Ecu.png", QSize(16, 16));
  m_ouIcons[defNODE_COMPOSITION_INDEX].addFile(
      ":/LDFEditorIcons/Resources/icons/22x22/Ecu.png", QSize(22, 22));
  m_ouIcons[defNODE_COMPOSITION_INDEX].addFile(
  ...
  connect(m_pouLDFDatabaseManager, SIGNAL(DataUpdated()), this,
          SLOT(onDataUpdate()));
  connect(m_pouLDFDatabaseManager, SIGNAL(DisplayModeChanged()), this,
...
void LDFElementView::onDisplayModeChanged() {
  if (currentItem() != nullptr) {
    TreeItemID ouTreeItemId =
        currentItem()->data(0, Qt::UserRole).value<TreeItemID>();
...
void LDFElementView::showContextMenu(QMenu& ouMenu, QTreeWidgetItem* item,
...
void LDFElementView::vPopulateLinElement(QTreeWidgetItem* pTopTreeItem,
                                         eClusterElementType ouClusterElement,
                                         std::string strItemTitle, QIcon& icon,
                                         int nTreeHeaderId) {
...
void LDFElementView::vPopulateLinEcus(QTreeWidgetItem* pTopTreeItem) {
  ...
  for (int i = 0; i < LIN_MAX_ECU_TYPES; i++) {
    ...
    pElementTopTreeItem[i]->setText(0,
                                    QString::fromStdString(strLinFrameTpes[i]));
  ...
  for (auto itrSignal : ouElementMap) {
    ...
    switch (ouECUProps.m_eEcuType) {
      case eMaster:
        ...
        pElementItem[LIN_MASTER_ECU]->setText(0,
        ...
        m_UidTreeWidgetMap[ouTreeItemID.m_uidElement] =
            pElementItem[LIN_MASTER_ECU];
        ouVariant.setValue(ouTreeItemID);
      ...
      case eSlave:
        ...
        pElementItem[LIN_SLAVE_ECU]->setText(0,
                                             QString::fromStdString(strName));
...
void LDFElementView::SetLDFNetworkView(LDFNetworkView* pouLDFNetworkView) {
  ...
  connect(this, SIGNAL(ElementCreated(UID_ELEMENT)), m_pouLDFNetworkView,
          SLOT(OnElementCreated(UID_ELEMENT)));
}
...
void LDFElementView::OnSlaveNodeDelete(UID_ELEMENT uid) {
  ...
  if (EC_SUCCESS ==
      m_pBaseCluster->GetElement(eEcuElement, uid, (IElement**)&pEcu)) {
...
void LDFElementView::vPopulateLinFrames(QTreeWidgetItem* pTopTreeItem) {
  ...
  std::string strLinFrameTpes[] = {"Unconditional Frames", "Event Triggered",
                                   "Sporadic Frames", "Diagnostic Frames"};

  int nTreeId[] = {defTRRE_ITEM_UNCONDITIONAL, defTREE_ITEM_EVENT_TRIGGERED,
                   defTREE_ITEM_SPORADIC, defTREE_ITEM_DIAGNOSTIC};

  for (int i = 0; i < LIN_MAX_FRAME_TYPES; i++) {
    if (ouLINSettings.m_dProtocolVers <= defVersion_1_3 &&
        nTreeId[i] == defTREE_ITEM_SPORADIC) {
      continue;
    }
  ...
  for (int nFrameIndex = 0; nFrameIndex < LIN_MAX_FRAME_TYPES; nFrameIndex++) {
    if (nFrameIndex == LIN_SPORADIC_FRAME_INDEX &&
        ouLINSettings.m_dProtocolVers <= defVersion_1_3) {
      continue;
    }
...
void LDFElementView::vPopulateLinEventTrigFrames(
    QTreeWidgetItem* pElementTopTreeItem) {
  std::map<UID_ELEMENT, IElement*> ouFrameMap;
...
void LDFElementView::vPopulateLinDiagFrames(
    QTreeWidgetItem* pElementTopTreeItem) {
  std::map<UID_ELEMENT, IElement*> ouFrameMap;
  m_pBaseCluster->GetElementList(eFrameElement, ouFrameMap);
  QString omstrFrameId;
...
void LDFElementView::vPopulateLinUnconditionalFrames(
    QTreeWidgetItem* pElementTopTreeItem) {
  std::map<UID_ELEMENT, IElement*> ouFrameMap;
  m_pBaseCluster->GetElementList(eFrameElement, ouFrameMap);
  QString omstrFrameId;
...
int LDFElementView::nGetDigFrameTreeWidgetItem(
    IFrame* pDigFrame, QTreeWidgetItem*& pouTreeWidget) {
  unsigned int unId = 0;
  std::string strName;
  char chText[33];
  TreeItemID ouTreeItemID;
...
void LDFElementView::vPopulateLinSignalGroups(
    QTreeWidgetItem* pElementTopTreeItem) {
  vPopulateLinElement(pElementTopTreeItem, eSignalGroupElement, "Signal Groups",
                      m_ouIcons[defSIGNAL_ICON_INDEX],
                      defTREE_ITEM_SIGNALGROUP);
}
...
void LDFElementView::vPopulateLinSignals(QTreeWidgetItem* pTopTreeItem) {
  ...
  for (int i = 0; i < LIN_MAX_SIGNAL_TYPES; i++) {
    ...
    m_pDiagElementTopTreeItem[i]->setText(
        0, QString::fromStdString(strLinFrameTpes[i]));
  ...
  for (auto itrSignal : ouElementMap) {
    ...
    switch (ouSignalProps.m_ouSignalType) {
      case eSignalNormal:
        ...
        pElementItem[LIN_NORMAL_SIGNAL]->setText(
            0, QString::fromStdString(strName));
        pElementItem[LIN_NORMAL_SIGNAL]->setIcon(
            0, m_ouIcons[defSIGNAL_ICON_INDEX]);

        ouTreeItemID.m_uidElement = itrSignal.second->GetUniqueId();
        m_UidTreeWidgetMap[ouTreeItemID.m_uidElement] =
            pElementItem[LIN_NORMAL_SIGNAL];
        ouVariant.setValue(ouTreeItemID);
        pElementItem[LIN_NORMAL_SIGNAL]->setData(0, Qt::UserRole, ouVariant);

        LinElementItem[LIN_NORMAL_SIGNAL].push_back(
            pElementItem[LIN_NORMAL_SIGNAL]);
        break;
      case eSignalDiag:
        pElementItem[LIN_DIAGNOSTICS_SIGNAL] = new QTreeWidgetItem();
        pElementItem[LIN_DIAGNOSTICS_SIGNAL]->setText(
            0, QString::fromStdString(strName));
        pElementItem[LIN_DIAGNOSTICS_SIGNAL]->setIcon(
            0, m_ouIcons[defSIGNAL_ICON_INDEX]);

        ouTreeItemID.m_uidElement = itrSignal.second->GetUniqueId();
        m_UidTreeWidgetMap[ouTreeItemID.m_uidElement] =
            pElementItem[LIN_DIAGNOSTICS_SIGNAL];
        ouVariant.setValue(ouTreeItemID);
        pElementItem[LIN_DIAGNOSTICS_SIGNAL]->setData(0, Qt::UserRole,
                                                      ouVariant);

        LinElementItem[LIN_DIAGNOSTICS_SIGNAL].push_back(
            pElementItem[LIN_DIAGNOSTICS_SIGNAL]);
        break;
      default:
        break;
...
void LDFElementView::vPopulateLinCoding(QTreeWidgetItem* pTopTreeItem) {
  vPopulateLinElement(pTopTreeItem, eCodingElement, "Codings",
                      m_ouIcons[defCODING_ICON_INDEX], defTREE_ITEM_CODING);
}

void LDFElementView::vPopulateLinScheduleTables(QTreeWidgetItem* pTopTreeItem) {
  vPopulateLinElement(pTopTreeItem, eScheduleTableElement, "Schedule Tables",
                      m_ouIcons[defSCHEDULETABLE_ICON_INDEX],
                      defTREE_ITEM_SCHEDULETABLE);
}

void LDFElementView::vPopulateLinNodeComposition(
    QTreeWidgetItem* pTopTreeItem) {
  LIN_Settings ouLINSettings;
...
void LDFElementView::CreateHeaderPopupMenus() {
  QAction* pouAction;
  for (unsigned int unIndex = eLinClusterHeaderPopup;
       unIndex < eTotalHeaderPopup; unIndex++) {
    switch (unIndex) {
      case eLinClusterHeaderPopup:
        pouAction = m_ouHeaderPopupMenus[unIndex].addAction(defEDIT);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnEditLinCluster()));
        break;
      ...
      case eUnconditionalFrameHeaderPopup: {
        pouAction = m_ouHeaderPopupMenus[unIndex].addAction(defNEW);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnNewUnCondFrameElement()));
      } break;
      case eEventTriggeredFrameHeaderPopup: {
        pouAction = m_ouHeaderPopupMenus[unIndex].addAction(defNEW);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnNewEventTrigFrameElement()));
      } break;
      case eSporadicFrameHeaderPopup:
        pouAction = m_ouHeaderPopupMenus[unIndex].addAction(defNEW);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnNewSporadicFrameElement()));
        break;
      ...
      case eScheduleTableHeaderPopup: {
        pouAction = m_ouHeaderPopupMenus[unIndex].addAction(defNEW);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnNewScheduleTable()));
      } break;
      case eDiagnosticFrameHeaderPopup:
        pouAction = m_ouHeaderPopupMenus[unIndex].addAction(defADD_DIAGSUPPORT);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnAddDiagSupport()));
        pouAction =
            m_ouHeaderPopupMenus[unIndex].addAction(defREMOVE_DIAGSUPPORT);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnRemoveDiagSupport()));
        break;
      case eSignalGroupHeaderPopUp:
        pouAction = m_ouHeaderPopupMenus[unIndex].addAction(defNEW);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnNewSignalGroup()));
        break;
...
void LDFElementView::CreateElementPopupMenus() {
  QAction* pouAction;
  for (unsigned int unIndex = eMasterElementPopup; unIndex < eTotalElementPopup;
       unIndex++) {
    switch (unIndex) {
      case eMasterElementPopup: {
        pouAction = m_ouElementPopupMenus[unIndex].addAction(defEDIT);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnEditMasterElement()));
        break;
      }
      case eSlaveElementPopup: {
        pouAction = m_ouElementPopupMenus[unIndex].addAction(defEDIT);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnEditSlaveElement()));

        pouAction = m_ouElementPopupMenus[unIndex].addAction(defDELETE);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnDeleteSlaveElement()));
        break;
      }
      case eUnconditionalFrameElementPopup: {
        pouAction = m_ouElementPopupMenus[unIndex].addAction(defEDIT);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnEditUnCondFrameElement()));

        pouAction = m_ouElementPopupMenus[unIndex].addAction(defDELETE);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnDeleteUnCondFrameElement()));
      } break;
      case eEventTriggeredFrameElementPopup: {
        pouAction = m_ouElementPopupMenus[unIndex].addAction(defEDIT);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnEditEventTrigFrameElement()));

        pouAction = m_ouElementPopupMenus[unIndex].addAction(defDELETE);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnDeleteEventTrigFrameElement()));
      } break;
      case eSporadicFrameElementPopup: {
        pouAction = m_ouElementPopupMenus[unIndex].addAction(defEDIT);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnEditSporadicFrameElement()));

        pouAction = m_ouElementPopupMenus[unIndex].addAction(defDELETE);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnDeleteSporadicFrameElement()));
      } break;
      ...
      case eScheduleTableElementPopup: {
        pouAction = m_ouElementPopupMenus[unIndex].addAction(defEDIT);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnEditScheduleTable()));

        pouAction = m_ouElementPopupMenus[unIndex].addAction(defDELETE);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnDeleteScheduleTable()));
      } break;
      ...
      case eSignalGroupElementPopup:
        pouAction = m_ouElementPopupMenus[unIndex].addAction(defEDIT);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnEditSignalGroup()));

        pouAction = m_ouElementPopupMenus[unIndex].addAction(defDELETE);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnDeleteSignalGroup()));
        break;
      case eNodeConfigElementPopup:
        pouAction = m_ouElementPopupMenus[unIndex].addAction(defEDIT);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnEditNodeConfig()));

        pouAction = m_ouElementPopupMenus[unIndex].addAction(defDELETE);
        connect(pouAction, SIGNAL(triggered()), this,
                SLOT(vOnDeleteNodeConfig()));
        break;
    };
  }
}
...
void LDFElementView::vCreateNodeConfig(INodeConfiguration* pNodeConfig,
                                       QTreeWidgetItem* pCurrItem) {
...
void LDFElementView::vOnEditNodeConfig() {
  ...
  if (nullptr != pItem) {
    ...
    INodeConfiguration* pouNodeConfig = nullptr;
    m_pBaseCluster->GetElement(eLinNodeComposition, ouTreeItemId.m_uidElement,
                               (IElement**)&pouNodeConfig);
...
void LDFElementView::vOnDeleteNodeConfig() {
  ...
  if (nullptr != pItem) {
    ...
    m_pBaseCluster->GetElement(eLinNodeComposition, uid.m_uidElement,
                               (IElement**)&pouNodeConfig);
    if (nullptr != pouNodeConfig) {
...
void LDFElementView::vOnEditScheduleTable() {
  ...
  if (nullptr != pItem) {
    ...
    m_pBaseCluster->GetElement(eScheduleTableElement, ouTreeItemId.m_uidElement,
                               (IElement**)&pouScheduleTable);
...
void LDFElementView::vOnEditSignalGroup() {
  ...
  if (nullptr != pItem) {
    ...
    m_pBaseCluster->GetElement(eSignalGroupElement, ouTreeItemId.m_uidElement,
                               (IElement**)&pouScheduleTable);
    if (nullptr != pouScheduleTable) {
      pouScheduleTable->RegisterForChangeNotification(this);
...
void LDFElementView::vOnDeleteSignalGroup() {
  ...
  if (nullptr != pItem) {
    ...
    TreeItemID uid = pItem->data(0, Qt::UserRole).value<TreeItemID>();
    m_pBaseCluster->GetElement(eSignalGroupElement, uid.m_uidElement,
                               (IElement**)&pouElement);
...
void LDFElementView::vOnDeleteScheduleTable() {
  ...
  if (nullptr != pItem) {
    ...
    TreeItemID uid = pItem->data(0, Qt::UserRole).value<TreeItemID>();
    m_pBaseCluster->GetElement(eScheduleTableElement, uid.m_uidElement,
                               (IElement**)&pouElement);
    if (nullptr != pouElement) {
      auto itr = m_UidTreeWidgetMap.find(uid.m_uidElement);
      if (itr != m_UidTreeWidgetMap.end()) {
...
void LDFElementView::vCreateSignalGroup(ISignalGroup* pouSignalGroup,
                                        QTreeWidgetItem* pouParentTree) {
...
void LDFElementView::vCreateScheduleTable(IScheduleTable* pouSchedTable,
                                          QTreeWidgetItem* pouParentTree) {
...
void LDFElementView::vOnEditCoding() {
  ...
  if (nullptr != pItem) {
    TreeItemID ouTreeItemId = pItem->data(0, Qt::UserRole).value<TreeItemID>();
    ICoding* pouCoding = nullptr;
    m_pBaseCluster->GetElement(eCodingElement, ouTreeItemId.m_uidElement,
                               (IElement**)&pouCoding);
...
void LDFElementView::vOnDeleteCoding() {
  ...
  if (nullptr != pItem) {
    ...
    TreeItemID uid = pItem->data(0, Qt::UserRole).value<TreeItemID>();
    m_pBaseCluster->GetElement(eCodingElement, uid.m_uidElement,
                               (IElement**)&pouCoding);
    if (nullptr != pouCoding) {
      auto itr = m_UidTreeWidgetMap.find(uid.m_uidElement);
      if (itr != m_UidTreeWidgetMap.end()) {
...
void LDFElementView::vOnEditSignal() {
  ...
  if (nullptr != pItem) {
    TreeItemID ouTreeItemId = pItem->data(0, Qt::UserRole).value<TreeItemID>();
    ISignal* pouSignal = nullptr;
    m_pBaseCluster->GetElement(eSignalElement, ouTreeItemId.m_uidElement,
                               (IElement**)&pouSignal);
...
void LDFElementView::vOnDeleteSignal() {
  ...
  if (nullptr != pItem) {
    ...
    TreeItemID uid = pItem->data(0, Qt::UserRole).value<TreeItemID>();
    m_pBaseCluster->GetElement(eSignalElement, uid.m_uidElement,
                               (IElement**)&pouSignal);
    if (nullptr != pouSignal) {
      auto itr = m_UidTreeWidgetMap.find(uid.m_uidElement);
      if (itr != m_UidTreeWidgetMap.end()) {
...
void LDFElementView::vOnEditMasterElement() {
  if (selectedItems().size() > 0) {
    ...
    IElement* pIECu = nullptr;

    m_pouLDFDatabaseManager->GetLDFCluster()->GetElement(
        eEcuElement, ouItemId.m_uidElement, &pIECu);
...
ERRORCODE LDFElementView::OnClusterChange(eAction eActionType, UID_ELEMENT nId,
                                          eClusterElementType& ouElementType,
                                          void* pAcionData, void* pUserData) {
...
void LDFElementView::vHandleElementChange(eAction eActionType, UID_ELEMENT nId,
                                          void* pAcionData) {
  if (eDeleted == eActionType || eBeforeDeletion == eActionType) {
    ...
    m_pBaseCluster->GetElement(m_pBaseCluster->GetElementType(nId), nId,
                               &pElement);
    if (nullptr != pElement) {
...
void LDFElementView::vCreateCoding(ICoding* pouCoding,
                                   QTreeWidgetItem* pouParentTree) {
  if (nullptr == pouCoding) {
    return;
  }
...
void LDFElementView::vCreateSignal(ISignal* pouSignal,
                                   QTreeWidgetItem* pouParentTree) {
  if (nullptr == pouSignal) {
    return;
  }
...
void LDFElementView::vCreateSlaveEcu(IEcu* pouEcu,
                                     QTreeWidgetItem* pouParentTree) {
...
void LDFElementView::MapNodeToSignals(IFrame* pouFrame, IEcu* pouEcu,
                                      eDIR oueDir) {
...
void LDFElementView::vOnEditSlaveElement() {
  ...
  if (nullptr != pItem) {
    TreeItemID uid = pItem->data(0, Qt::UserRole).value<TreeItemID>();
    m_pBaseCluster->GetElement(eEcuElement, uid.m_uidElement,
                               (IElement**)&pouEcu);
    if (nullptr != pouEcu) {
...
void LDFElementView::vOnDeleteSlaveElement() {
  ...
  if (nullptr != pItem) {
    ...
    if (pItem->parent()->childCount() <= 1) {
      reply = QMessageBox::critical(this, "Delete?",
                                    "Alteast one Slave should exist");
      return;
    }

    reply = QMessageBox::question(this, "Delete?",
                                  "All frames and signals mapped to the Slave "
...
void LDFElementView::onItemDoubleClicked(QTreeWidgetItem* pTreeItem,
                                         int column) {
  if (nullptr != pTreeItem) {
    ...
    if (eLdfItem == objTreeItemData.m_eTreeElementType) {
      IElement* pElement;
      eClusterElementType eType =
          m_pBaseCluster->GetElementType(objTreeItemData.m_uidElement);
      m_pBaseCluster->GetElement(eType, objTreeItemData.m_uidElement,
                                 &pElement);
...
void LDFElementView::onCustomContextMenu(const QPoint& point) {
  ...
  if (nullptr != pTreeItem) {
    ...
    switch (objTreeItemData.m_eTreeElementType) {
      case eTreeHeader:
        DisplayHeaderPopupMenu(viewport()->mapToGlobal(point), pTreeItem,
                               objTreeItemData.m_uidElement);
        break;
      case eLdfItem:
        DisplayElementPopupMenu(viewport()->mapToGlobal(point), pTreeItem,
                                objTreeItemData.m_uidElement);
        break;
    };
  }
...
void LDFElementView::DisplayHeaderPopupMenu(const QPoint& point,
                                            QTreeWidgetItem* pTreeItem,
                                            UID_ELEMENT uidElement) {
  switch (uidElement) {
    case defTREE_ITEM_LINCLUSTER:
      showContextMenu(m_ouHeaderPopupMenus[eLinClusterHeaderPopup], pTreeItem,
                      point);
      break;
    case defTREE_ITEM_MASTER:
      break;
    case defTREE_ITEM_SLAVE:
      showContextMenu(m_ouHeaderPopupMenus[eSlaveHeaderPopup], pTreeItem,
                      point);
      break;
    case defTRRE_ITEM_UNCONDITIONAL:
      showContextMenu(m_ouHeaderPopupMenus[eUnconditionalFrameHeaderPopup],
                      pTreeItem, point);
      break;
    case defTREE_ITEM_SPORADIC:
      showContextMenu(m_ouHeaderPopupMenus[eSporadicFrameHeaderPopup],
                      pTreeItem, point);
      break;
    case defTREE_ITEM_EVENT_TRIGGERED:
      showContextMenu(m_ouHeaderPopupMenus[eEventTriggeredFrameHeaderPopup],
                      pTreeItem, point);
      break;
    case defTREE_ITEM_DIAGNOSTIC: {
      ...
      if (m_bDiagFrames[0] == false || m_bDiagFrames[0] == false) {
        ouMenu.addAction(
            m_ouHeaderPopupMenus[eDiagnosticFrameHeaderPopup].actions().at(0));
      } else {
        ouMenu.addAction(
            m_ouHeaderPopupMenus[eDiagnosticFrameHeaderPopup].actions().at(1));
      }
      showContextMenu(ouMenu, pTreeItem, point);
    } break;
    case defTREE_ITEM_NORMAL_SIGNAL:
      showContextMenu(m_ouHeaderPopupMenus[eSignalHeaderPopup], pTreeItem,
                      point);
      break;
    case defTREE_ITEM_DIAG_SIGNAL:
      break;
    case defTREE_ITEM_CODING:
      showContextMenu(m_ouHeaderPopupMenus[eCodingHeaderPopup], pTreeItem,
                      point);
      break;
    case defTREE_ITEM_SCHEDULETABLE:
      showContextMenu(m_ouHeaderPopupMenus[eScheduleTableHeaderPopup],
                      pTreeItem, point);
      break;
    case defTREE_ITEM_SIGNALGROUP:
      showContextMenu(m_ouHeaderPopupMenus[eSignalGroupHeaderPopUp], pTreeItem,
                      point);
      break;
    case defTREE_ITEM_NODECOMP:
      showContextMenu(m_ouHeaderPopupMenus[eNodeConfigHeaderPopup], pTreeItem,
                      point);
      break;
  };
}

void LDFElementView::DisplayElementPopupMenu(const QPoint& point,
                                             QTreeWidgetItem* pTreeItem,
                                             UID_ELEMENT uidElement) {
  eClusterElementType eType =
      m_pouLDFDatabaseManager->GetLDFCluster()->GetElementType(uidElement);
  ...
  switch (eType) {
    case eEcuElement:
      ...
      m_pouLDFDatabaseManager->GetLDFCluster()->GetElement(
          eEcuElement, uidElement, &pElement);

      if (nullptr != pElement) {
        if (EC_SUCCESS == ((IEcu*)pElement)->GetProperties(ouEcuProps)) {
          if (ouEcuProps.m_eEcuType == eMaster) {
            showContextMenu(m_ouElementPopupMenus[eMasterElementPopup],
                            pTreeItem, point);
          } else if (ouEcuProps.m_eEcuType == eSlave) {
            showContextMenu(m_ouElementPopupMenus[eSlaveElementPopup],
                            pTreeItem, point);
          }
        }
      }
    ...
    case eFrameElement:
      m_pouLDFDatabaseManager->GetLDFCluster()->GetElement(
          eFrameElement, uidElement, &pElement);

      if (nullptr != pElement) {
        if (EC_SUCCESS == ((IFrame*)pElement)->GetProperties(ouFrameProps)) {
          if (ouFrameProps.m_eLinFrameType == eLinUnconditionalFrame) {
            showContextMenu(
                m_ouElementPopupMenus[eUnconditionalFrameElementPopup],
                pTreeItem, point);
          } else if (ouFrameProps.m_eLinFrameType == eEventTriggered) {
            showContextMenu(
                m_ouElementPopupMenus[eEventTriggeredFrameElementPopup],
                pTreeItem, point);
          } else if (ouFrameProps.m_eLinFrameType == eSporadic) {
            showContextMenu(m_ouElementPopupMenus[eSporadicFrameElementPopup],
                            pTreeItem, point);
          }
        }
      }
    ...
    case eSignalElement:
      ...
      m_pouLDFDatabaseManager->GetLDFCluster()->GetElement(
          eSignalElement, uidElement, &pElement);

      if (nullptr != pElement) {
        if (EC_SUCCESS == ((ISignal*)pElement)->GetProperties(ouSignalProps)) {
          if (ouSignalProps.m_ouSignalType == eSignalNormal) {
            showContextMenu(m_ouElementPopupMenus[eSignalElementPopup],
                            pTreeItem, point);
          }
        }
      }
      break;
    case eCodingElement:
      showContextMenu(m_ouElementPopupMenus[eCodingElementPopup], pTreeItem,
                      point);
      break;
    case eScheduleTableElement:
      showContextMenu(m_ouElementPopupMenus[eScheduleTableElementPopup],
                      pTreeItem, point);
      break;
    case eSignalGroupElement:
      showContextMenu(m_ouElementPopupMenus[eSignalGroupElementPopup],
                      pTreeItem, point);
      break;
    case eLinNodeComposition:
      showContextMenu(m_ouElementPopupMenus[eNodeConfigElementPopup], pTreeItem,
                      point);
      break;
  };
}
...
void LDFElementView::vOnEditUnCondFrameElement() {
  if (selectedItems().size() > 0) {
    ...
    IFrame* pIFrame;
    m_pouLDFDatabaseManager->GetLDFCluster()->GetElement(
        eFrameElement, ouItemId.m_uidElement, (IElement**)&pIFrame);
    if (nullptr != pIFrame) {
...
void LDFElementView::vCreateFrameElement(IFrame* pouFrame,
...
void LDFElementView::vOnDeleteUnCondFrameElement() {
  ...
  if (nullptr != pItem) {
    ...
    TreeItemID uid = pItem->data(0, Qt::UserRole).value<TreeItemID>();
    m_pBaseCluster->GetElement(eFrameElement, uid.m_uidElement,
                               (IElement**)&pouFrame);
    if (nullptr != pouFrame) {
      auto itr = m_UidTreeWidgetMap.find(uid.m_uidElement);
      if (itr != m_UidTreeWidgetMap.end()) {
...
void LDFElementView::vOnEditSporadicFrameElement() {
  if (selectedItems().size() > 0) {
    ...
    IElement* pIFrame;
    m_pouLDFDatabaseManager->GetLDFCluster()->GetElement(
        eFrameElement, ouItemId.m_uidElement, &pIFrame);
    if (nullptr != pIFrame) {
      pIFrame->RegisterForChangeNotification(this);
...
void LDFElementView::vCreateSporadicFrameElement(IFrame* pouFrame,
                                                 QTreeWidgetItem* pParentItem) {
  QTreeWidgetItem* pFrameItem = new QTreeWidgetItem();
  UID_ELEMENT uidFrame = pouFrame->GetUniqueId();
  unsigned int unFrameId;
