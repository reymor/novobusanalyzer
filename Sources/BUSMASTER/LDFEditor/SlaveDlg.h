#ifndef BUSMASTER_LDFEDITOR_SLAVEDLG_H_
#define BUSMASTER_LDFEDITOR_SLAVEDLG_H_
...
class SlaveDlg : public QDialog {
 ...
 public:
  SlaveDlg(ICluster* ouCluster, IEcu** pouEcu, bool bNew = true,
           QWidget* parent = 0);
  ~SlaveDlg();
...
#endif  // BUSMASTER_LDFEDITOR_SLAVEDLG_H_