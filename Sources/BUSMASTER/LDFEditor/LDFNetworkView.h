#ifndef BUSMASTER_LDFEDITOR_LDFNETWORKVIEW_H_
#define BUSMASTER_LDFEDITOR_LDFNETWORKVIEW_H_
...
class EcuTreeWidgets {
 public:
  ...
  EcuTreeWidgets() {
    ...
    m_pTreeWidgets[def_RxFrameTreeWidget_Index]->setText(0,
                                                         "Subscribed Frames");
    m_pTreeWidgets[def_TxSignalTreeWidget_Index]->setText(0,
                                                          "Published Signals");
    m_pTreeWidgets[def_RxSignalTreeWidget_Index]->setText(0,
                                                          "Subscribed Signals");
  }
};
...
#endif  // BUSMASTER_LDFEDITOR_LDFNETWORKVIEW_H_