#ifndef BUSMASTER_LDFEDITOR_SCHEDULETABLEDLG_H_
#define BUSMASTER_LDFEDITOR_SCHEDULETABLEDLG_H_
...
class ScheduleTableDlg : public QDialog {
 ...
 private:
  ...
  eScheduleCommand_Type vGetFrameType(eLinFrameType ouFrameType,
  ...
  void vUpdateScheduleTableItems(
...
#endif  // BUSMASTER_LDFEDITOR_SCHEDULETABLEDLG_H_