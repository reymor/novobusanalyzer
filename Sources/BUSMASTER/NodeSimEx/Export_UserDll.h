...
typedef double(*GETFPPHYSICALVALUE)(int nBus, unsigned long long nRawValue, int length, int type, unsigned long long unClusterId, const char* pchCodingName);
typedef double(*GETENGVALUE)(GETFPPHYSICALVALUE pfGetPhysicalValue);

typedef unsigned long long (*GETFPRAWVALUE)( int bus, double unEngValue, unsigned long long unClusterId, const char* pchCodingName );
typedef double(*GETRAWVALUE)(GETFPRAWVALUE pfGetPhysicalValue);
