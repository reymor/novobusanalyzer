...
struct sNODEINFO:private IDirectoryUpdate
{
    ...
    CMsgBufFSE<STLINDATA>* m_ouLinBufSE;
    DWORD m_dwClientId;
    ...
    virtual BOOL bStartThreadProc();
    virtual BOOL bTerminateThreadProc();
...
struct sNODELIST
{
    ...
    CGlobalObj* m_pGlobalObj;
    sNODELIST(ETYPE_BUS eBus, CGlobalObj* pGlobalObj) //: m_sNodeInfo(eBus)
    {
        m_eBus = eBus;
        //m_sNodeInfom_eBus = m_eBus;
...
public:
    ...
    void vCreateNodeInfoPtr(sNODEINFO* sNodeInfo)
    {
        m_sNodeInfo = sNodeInfo;
        /*m_sNodeInfo->m_eBus = m_eBus;
        m_sNodeInfo->m_pGlobalObj = m_pGlobalObj;*/
    }
};
...
public:
    ...
    CSimSysNodeInfo(ETYPE_BUS eBus, CGlobalObj* pGlobalObj);
