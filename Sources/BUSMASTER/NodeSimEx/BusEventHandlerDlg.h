...
private:
    ...
    BOOL m_bIsDelete;
    ETYPE_BUS m_eBus;
    bool m_bEnablePreConnect;

public:
    CBusEventHandlerDlg(ETYPE_BUS eBus, CFunctionEditorDoc* pDoc, bool bEnablePreConnect = false, CWnd* pParent = nullptr, BOOL bIsDelete = FALSE);   // standard constructor
