...
class CFunctionView : public CRichEditView
{
    // Construction
public:
    CFunctionView(CGlobalObj* pGlobalObj = nullptr);
...
protected:
    ...
    virtual afx_msg void OnInsertSignal();
    virtual afx_msg void OnInsertPdu();
    virtual afx_msg void OnInsertMessage();
    afx_msg void OnInsertFunction();
    afx_msg void OnCut();
    virtual bool bDisableBusSpecificMenu();
    //}}AFX_MSG
